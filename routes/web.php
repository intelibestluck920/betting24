...
Route::group(['prefix' => 'bet365'], function () {
    Route::get('/inplay', 'Bet365Controller@inplay')->name('bet365.inplay');
    Route::get('/inplay-filter/{sportId}', 'Bet365Controller@inplayFilter')->name('bet365.inplay_filter');
    Route::get('/inplay-events/{fi}', 'Bet365Controller@inplayEvents')->name('bet365.inplay_events');
    Route::get('/upcoming/{sportId}', 'Bet365Controller@upcoming')->name('bet365.upcoming');
    Route::get('/prematch-odds/{eventId}', 'Bet365Controller@prematchOdds')->name('bet365.prematch_odds');
    Route::get('/results/{eventId}', 'Bet365Controller@results')->name('bet365.results');
});
...
Route::get('/countriesJson', 'FrontendController@countriesJson')->name('countriesJson');
...
Route::get('/kyc_policy', 'FrontendController@kyc_policy')->name('kyc_policy');
Route::get('/bonusterm', 'FrontendController@bonusterm')->name('bonusterm');
Route::get('/gambling', 'FrontendController@gambling')->name('gambling');
Route::get('/about', 'FrontendController@about')->name('about');
Route::get('/casino_promotion', 'FrontendController@casino_promotion')->name('casino_promotion');
Route::get('/sport_promotion', 'FrontendController@sport_promotion')->name('sport_promotion');
Route::get('/deposit_withdraw', 'FrontendController@deposit_withdraw')->name('deposit_withdraw');
Route::get('/sportStat', 'FrontendController@sportStat')->name('sportStat');
Route::get('/casino', 'FrontendController@casino')->name('casino');
Route::get('/slot', 'FrontendController@slot')->name('slot');
