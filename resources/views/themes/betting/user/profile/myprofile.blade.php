                            ...
                            @if(in_array($user->identity_verify,[0,3])  )
                                ...
                                <form method="post" action="{{route('user.verificationSubmit')}}"
                                    ...
                                    @if(isset($identityForm))
                                        ...
                                        <div class="submit-btn-wrapper text-center text-md-left">
                                            <button type="submit"
                                                    class="cmn--btn w-100">@lang('Submit')</button>
                                        </div>
                                    @endif
                                </form>
                        ...
                        <div id="addressVerification"
                            ...
                            @if(in_array($user->address_verify,[0,3])  )
                                ...
                                <form method="post" action="{{route('user.addressVerification')}}"
                                            ...
                                            <div class="fileinput fileinput-new "
                                                ...
                                                <div class="img-input-div" style="color:white">
                                                    <span class="btn cmn--btn btn-file">
                                                        <span
                                                            class="fileinput-new " style="color:white"> @lang('Select Image') </span>
                                                        <span
                                                            class="fileinput-exists" style="color:white"> @lang('Change')</span>
                                    ...
                                    <div class="submit-btn-wrapper text-center text-md-left">
                                        <button type="submit"
                                                class="cmn--btn w-100" style="color:white">@lang('Submit')</button>
                                    </div>
                                </form>
