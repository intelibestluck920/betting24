...
@section('content')    <!--Global Main Body-->
                                    ...
                                    <div class="row gy-5 g-lg-5 align-items-center">
                                        <div class="col-lg-6">
                                            <div class="text-box p-3">
                                                <div class="header-text">
                                                    <h5 class="py-4">@lang(@$contact->heading)</h5>
                                                    <h3 class="pb-4">@lang(@$contact->sub_heading)</h3>
                                                    <p>
                                        ...
                                        <div class="col-lg-6">
                                            <form action="{{route('contact.send')}}" method="post">
                                                @csrf
                                                <h4 class="py-4">@lang('just drop us a line')</h4>
                                                <div class="row g-3">
