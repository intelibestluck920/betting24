<!-- live match table -->
<div v-if="showType == 'live' && allSports_filter.length != 0"  class="table-parent table-responsive d-sm-block d-none">
    <div class="live__heightlight mb__30" >
        ...
        <div class="heightlight__tab nexttogo__tab" v-for="(item, index) in allSports_filter">
...
<div  v-if="showType == 'upcoming' && upcoming_filter.length !=0"  class="table-parent table-responsive d-sm-block d-none">
    <div class="live__heightlight mb__30" >
        <div class="section__title">
            <h4>
                Manual games
        ...
        <div class="heightlight__tab nexttogo__tab" v-for="(item, index) in upcoming_filter">
            <table class="table table-striped">
        <thead>
        <tr>
            <th class="text-center">
