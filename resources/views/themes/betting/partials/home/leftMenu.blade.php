...
<div class="popular__events__left display991">
 <!-- <a href="{{route('countriesJson')}}"> upload json </a> -->
    ...
    @if(!in_array(Request::route()->getName(),['condition','policy','bonusterm','gambling','about','contact','kyc_policy','casino_promotion','sport_promotion','deposit_withdraw','sportStat']))
                    ...
                    <div class="tab-pane fade text-white  show active" id="nav-profilepre" role="tabpanel" aria-labelledby="nav-profile-tabpre" tabindex="0">
                        <div class="multiple__components">
                            ...
                            <div class="CC_div" id="icehocky" style="display:none">
                               ...
                               <!--  <a  @click="setLocalStorage(17,'icehocky')"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-icehockey icon_color"></i></span>
                                        <span class="score">
                                            Ice Hokey
...
<!-- ------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <!--   <a   @click="setLocalStorage(18)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-basketball icon_color"></i></span>
                                        <span class="score">
                                            Basketball
                                 ...
                                 <a   @click="setLocalStorage(13)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-tennis icon_color"></i></span>
                                        <span class="score">
                                            Tennis
                                ...
                                <a   @click="setLocalStorage(3)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-cricket icon_color"></i></span>
                                        <span class="score">
                                            Cricket
                                ...
                                <a  @click="setLocalStorage(92)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-ttennis icon_color"></i></span>
                                        <span class="score">
                                            Table Tennis
                                ...
                                <a   @click="setLocalStorage(91)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-volly icon_color"></i></span>
                                        <span class="score">
                                            Volleyball
                                ...
                                <a   @click="setLocalStorage(78)"  href="{{route('home')}}" class="prescore__items">
                                    <div class="prescore__left">
                                        <span><i class="icon-handball icon_color"></i></span>
                                        <span class="score">
                                            Handball
            ...
            <div class="prematch__wrap">
                <div class="prematch__scopre">
                    <a href="{{route('about')}}" class="prescore__items">
                        <div class="prescore__left">
                    ...
                    <a  href="{{route('condition')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                    ...
                    <a href="{{route('bonusterm')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                                Bonus terms
                    ...
                    <a href="{{route('gambling')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                    ...
                    <a href="{{route('policy')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                                Cookie Policy
                    ...
                    <a href="{{route('deposit_withdraw')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                    ...
                    <a  href="{{route('kyc_policy')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                                KYC Policy
                    ...
                    <a  href="{{route('sport_promotion')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                                Sport Promotions
                    ...
                    <a  href="{{route('sportStat')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                                Sports Stats
                    ...
                    <a  href="{{route('casino_promotion')}}" class="prescore__items">
                        <div class="prescore__left">
                            <span><i class="icon-football"></i></span>
                            <span class="score">
                             Casino Promotions
                 ...
                 <a  href="{{route('contact')}}" class="prescore__items">
                    <div class="prescore__left">
                        <span><i class="icon-football"></i></span>
                        <span class="score">
                            Contacts
        ...
        @endif
        @if(!in_array(Request::route()->getName(),['condition','policy','bonusterm','gambling','kyc_policy','sport_promotion','casino_promotion','about']))
