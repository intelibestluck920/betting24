                ...
                <div class="col-xxl-8 col-xl-8 col-lg-8 flex">
                    <div class="container-fluid p-0">
                        <div class="row g-0">
                            ...
                            @endif
                            @if(Request::routeIs('kyc_policy'))
                                <div class = "condition-content">
                                    @include($theme.'partials.home.kyc_policy')
                                    @include($theme.'partials.footer')
                                </div>
                            @endif
                            ...
                            @endif
                            @if(Request::routeIs('casino_promotion'))
                                <div class = "condition-content">
                                    @include($theme.'partials.home.casino_promotion')
                                    @include($theme.'partials.footer')
                                </div>
                            @endif
                            @if(Request::routeIs('sport_promotion'))
                                <div class = "condition-content">
                                    @include($theme.'partials.home.sport_promotion')
                                    @include($theme.'partials.footer')
                                </div>
                            @endif
                            @if(Request::routeIs('sportStat'))
                                <div class = "condition-content">
                                    @include($theme.'partials.home.sportStat')
                                    @include($theme.'partials.footer')
                                </div>
                            @endif
                            @if(Request::routeIs('deposit_withdraw'))
                                <div class = "condition-content">
                                    @include($theme.'partials.home.deposit_withdraw')
                                    @include($theme.'partials.footer')
                                </div>
                            @endif
                            <div class="content col-xxl-12 col-xl-12 col-lg-12" id="sport-content">
                                @if(!in_array(Request::route()->getName(),['condition','policy','bonusterm','gambling','about','kyc_policy','casino_promotion','sport_promotion','deposit_withdraw','sportStat']))
