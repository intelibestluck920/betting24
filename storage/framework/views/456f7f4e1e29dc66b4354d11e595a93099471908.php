    ...
    <div class="row justify-content-between ">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        <?php echo app('translator')->get('The RECASINO Affiliates program is flexible and offers services tailor-made for you. Your Revenue Share is calculated each month based on the number of monthly affiliated New Customers. The more new players you bring in, the bigger the Revenue Share! New customers must sign up using our Affiliate code and make at least one deposit into their gaming account.'); ?></p>
                    <div>
                        <form>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/user/referral.blade.php ENDPATH**/ ?>