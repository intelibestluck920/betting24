                ...
                <div class="col-lg-6 p-0">
                    <div class="text-box h-100">
                        <div class="overlay h-100">
                            <div class="text">
                                <h1 style="font-weight: unset;" class="font_change"><?php echo app('translator')->get('create an account'); ?></h1>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="create__btn d-flex justify-content-center mt-3">
                                <button class="cmn--btn" type="submit">
                                    <span><?php echo app('translator')->get('Sign Up'); ?></span>
                                </button>
                            </div>
                            ...
                            <p class="justify-content-center d-flex">
                                <a href="<?php echo e(route('login')); ?>" style="color:#0d6efd"><?php echo app('translator')->get('Login here'); ?></a>
                            </p>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/auth/register.blade.php ENDPATH**/ ?>