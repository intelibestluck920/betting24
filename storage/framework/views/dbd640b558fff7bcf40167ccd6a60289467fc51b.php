  ...
  <div class="main__body__wrap left__right__space w-100">
    <div class="live__heightlight mb__30">
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>This Privacy Policy describes the way in which RECASINO (otherwise referred to herein as "we" or "us") deal with the information and data you provide to us to enable us to manage your relationship with RECASINO.
          We will process any personal information provided to us whether via the RECASINO website (the "Website"), or otherwise held by us relating to you in the manner set out in this Privacy Policy. By submitting your information to us and using the Website you confirm your consent to the use of your personal information as set out in this Privacy Policy. If you do not agree with the terms of this Privacy Policy please do not use the Website or otherwise provide us with your personal information.</p>
        </div>
      </div>
      <div class="section__title">
          <h4>
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>The information and data about you which we may collect, use and process includes the following:
          ...
          <p>We may use your personal information and data together with other information for the purposes of:
            ...
            providing you with information about promotional offers and our products and services, where you have consented; monitoring transactions for the purposes of preventing fraud, irregular betting, money laundering and cheating.
          </p>
          <p>You can unsubscribe from it using the available functional.</p>
        </div>
      </div>
      <div class="section__title">
          <h4>
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>We are entitled to share the information we hold on you which includes personal data and betting history with the regulator, sporting bodies and other bodies, including the police, in order to investigate fraud and money laundering.</p>
        </div>
      </div>
      <div class="section__title">
          <h4>
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>We will take all reasonable steps as required by law to ensure that the personal information that we collect is accurately recorded and kept securely. All personal information will be destroyed when it is no longer required to be retained or by law.
          We do not warrant the security of any information which you transmit to us over the Internet. Any information which you transmit to us is transmitted at your own risk. However, once we receive your transmission, we will take reasonable steps to protect your personal information from misuse, loss or unauthorised access.</p>
        </div>
      </div>
      <div class="section__title">
          <h4>
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>Any changes we may make to our Privacy Policy in the future will be posted on this page and any such changes will become effective upon posting of the revised Privacy Policy.</p>
        </div>
      </div>
      <div class="section__title">
          <h4>
      ...
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          ...
          <p>In order to prevent the infiltration of criminal capital into the economy of the state, many countries fight against money laundering and the terrorism financing.
          ...
          <p>The company collects and keeps the passport or other ID of the User, and reports on all changes made in the account;
          ...
          <p>To verify and confirm the authenticity of the above-mentioned data, the Company may require the following documents:
...
<!-- </div> --><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/partials/home/policy.blade.php ENDPATH**/ ?>