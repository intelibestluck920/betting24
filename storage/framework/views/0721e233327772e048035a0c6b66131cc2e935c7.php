...
<div class="ecuador__match__fixing"  style="padding-top:0;">
    ...
    <div class="live__heightlight mb__30 ">
        <div class="section__title matchpage_banner" style="background-image: url(<?php echo e(getFile(config('location.logo.path').'match_background.png')); ?>); background-position: center;background-size: cover;padding: 50px 0 50px 0;margin-bottom:16px;" v-if="upcoming_details?.id">
    ...
    <div class="row g-4 font_change" v-if="upcoming_details?.id ">
                ...
                <div class="match__box mb__30">
                    ...
                    <div class="devaided__box">
                        <a href="#0" @click="addToSlip(upcoming_details?.newindex.results[0].schedule.sp.main[0].betdata)"
                            ...
                            <?php echo e('1'); ?> <br>&nbsp;{{Number(upcoming_details?.newindex.results[0].schedule.sp.main[0].odds).toFixed(2)}}
                        </a>
                        <a href="#0" @click="addToSlip(upcoming_details?.newindex.results[0].schedule.sp.main[1].betdata)"
                            class="point__box font_change" >
                            <?php echo e('x'); ?><br>{{Number(upcoming_details?.newindex.results[0].schedule.sp.main[1].odds).toFixed(2)}}
                        </a>
                        <a href="#0" @click="addToSlip(upcoming_details?.newindex.results[0].schedule.sp.main[2].betdata)" v-if="upcoming_details?.newindex.results[0].schedule.sp.main[2]"
                            class="point__box font_change" >
                           <?php echo e('2'); ?><br>&nbsp;{{Number(upcoming_details?.newindex.results[0].schedule.sp.main[2].odds).toFixed(2)}}
                        </a>
                    </div>
                </div>
        ...
        <div class="section__title matchpage_banner" style="background-image: url(<?php echo e(getFile(config('location.logo.path').'match_background.png')); ?>); background-position: center;background-size: cover;padding: 50px 0 50px 0;margin-bottom:16px;"
...
</div><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/partials/home/match.blade.php ENDPATH**/ ?>