...
unset($__errorArgs, $__bag); ?>
                            " name="username"
                               value="<?php echo e(old('username','admin')); ?>"  autocomplete="off" autofocus>
...
unset($__errorArgs, $__bag); ?>"
                               name="password" value="<?php echo e(old('password','admin')); ?>" autocomplete="current-password">
...
<?php echo $__env->make('admin.layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>