    ...
    <div class="row">
        <div class="col-sm-12">
                <div class="dashboard__body__wrap">
                    ...
                    <h3 class="account__head mb__30"><?php echo app('translator')->get($page_title); ?></h5>
                    <a href="<?php echo e(route('user.ticket.create')); ?>" class="cmn--btn "> <i
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/user/support/index.blade.php ENDPATH**/ ?>