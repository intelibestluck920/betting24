  ...
  <div class="main__body__wrap left__right__space w-100">
    <div class="live__heightlight mb__30">
      <div class="section__title">
          <h3 class="py-3">
            KYC Policy of RECASINO
          </h3>
          <h5>Last updated 2022. 11. 10</h5>
      </div>
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>When a user makes an aggregate lifetime total of deposits exceeding $100 or requests a withdrawal of any amount inside the RECASINO Platform, then it is compulsory for them to perform a full KYC process.
          ...
          They cannot deposit more than 500 USD in aggregate total
      ...
      <div class="section__title">
          <h4>
            <strong>1) Proof of ID</strong>
          </h4>
      </div>
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>Signature Is there</p>
          <p>
      ...
      <div class="section__title">
          <h4>
            <strong>2) Proof of Residence</strong>
          </h4>
      </div>
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          ...
          <p>
            ...
            Country is not a Restricted Country: United States of America and its territories, France and its territories, Netherlands and its territories and countries that form the Kingdom of Netherlands including Bonaire, Sint Eustatius, Saba, Aruba, Curacao and Sint Maarten, Australia and its territories, United Kingdom of Great Britain, Northern Ireland, Spain, and Cyprus and Europe Union.
      ...
      <div class="section__title">
          <h4>
            <strong>3) Selfie with ID</strong>
          </h4>
      </div>
      <div class="main__table main__table__tennis main__table__cricket">
        <div class="mt-3">
          <p>
            ...
            There is a deposit limit per transaction (max 20,000 USD)
...
<!-- </div> --><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/partials/home/kyc_policy.blade.php ENDPATH**/ ?>