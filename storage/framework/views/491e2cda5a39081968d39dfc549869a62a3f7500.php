                    ...
                    <div class="tab-content ">
                        <div id="home"
                            ...
                            <form action="<?php echo e(route('user.updateInformation')); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control recasino-input" type="text" name="firstname"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control recasino-input" type="text" name="lastname"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control recasino-input" type="text" name="username"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control recasino-input" type="email"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control recasino-input" type="text" readonly
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <select name="language_id" id="language_id" class="form-select recasino-input">
                                ...
                                <div class="form-group input-box mb-3">
                                    <textarea class="form-control recasino-input" name="address"
                        ...
                        <div id="menu1" class="container mt-4 tab-pane <?php echo e($errors->has('password') ? 'active' : ''); ?>">
                            ...
                            <form method="post" action="<?php echo e(route('user.updatePassword')); ?>">
                                ...
                                <div class="form-group input-box mb-3">
                                    <input id="password" type="password" class="form-control recasino-input"
                                ...
                                <div class="form-group input-box mb-3">
                                    <input id="password_confirmation" type="password"
                                           ...
                                           class="form-control recasino-input">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group input-box mb-3">
                                            <select name="identity_type" id="identity_type"
                                                    class="form-select recasino-input">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="submit-btn-wrapper text-center text-md-left">
                                            <button type="submit"
                                                    class="cmn--btn w-100"><?php echo app('translator')->get('Submit'); ?></button>
                                        </div>
                                    <?php endif; ?>
                                </form>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group input-box">
                                            <div class="fileinput fileinput-new "
                                                ...
                                                <div class="img-input-div" style="color:white">
                                                    <span class="btn cmn--btn btn-file">
                                                        <span
                                                            class="fileinput-new " style="color:white"> <?php echo app('translator')->get('Select Image'); ?> </span>
                                                        <span
                                                            class="fileinput-exists" style="color:white"> <?php echo app('translator')->get('Change'); ?></span>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="submit-btn-wrapper text-center text-md-left">
                                        <button type="submit"
                                                class="cmn--btn w-100" style="color:white"><?php echo app('translator')->get('Submit'); ?></button>
                                    </div>
                                </form>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u428797525/domains/recasino.io/public_html/resources/views/themes/betting/user/profile/myprofile.blade.php ENDPATH**/ ?>