...
const toggleSidebar = (id) => {
        const sportContentElement = document.getElementById("sport-content");
    if (sportContentElement) {
      sportContentElement.classList.add("d-none");
    }
...
const removeClass = (id) => {
    const element = document.getElementById(id);
    document.getElementById('sport-content').classList.remove('d-none')
...
$(document).ready(function () {
    ...
    function updateSkitterImage() {
        var windowWidth = $(window).width();
        var $skitterImage = $('.image_main');
        console.log(windowWidth);
        if (windowWidth <= 575) {

            $skitterImage.attr('src', 'https://recasino.io/assets/uploads/content/647718338d7fc16855265792nd.jpg');
        } else {
            $skitterImage.attr('src', 'https://recasino.io/assets/uploads/content/647718338d7fc1685526579.jpg');
        }
    }
    updateSkitterImage();
    // owl carousel
